...
solFiles=(
  ...
  # dt helper
  libraries/DtHelper # generated by gen_dthelper()
)

dld_solc() {
  curl -L "https://github.com/ethereum/solidity/releases/download/${SOLC_VER}/solc-static-linux" -o solc && chmod +x solc
